...
export class TipoIncidenciaController {
  ...
  @ApiOperation({
    ...
    description:
      'Retorna una lista de todos los tipos de incidencia del sistema',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Retorna todos los tipos de incidencia con una prioridad específica',
  })
  @ApiParam({
    name: 'prioridad',
  ...
  @ApiOperation({
    ...
    description:
      'Elimina lógicamente un tipo de incidencia marcándolo como inactivo',
  })
  @ApiParam({
    name: 'id',
    description: 'ID único del tipo de incidencia',
  ...
  @ApiResponse({
    status: 400,
    description:
      'No se puede eliminar un tipo de incidencia con incidencias activas asociadas',
  })
