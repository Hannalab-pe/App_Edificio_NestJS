...
export class IncidenciaController {
  ...
  @ApiOperation({
    ...
    description:
      'Retorna una lista de todas las incidencias reportadas en el edificio',
  })
  @ApiQuery({
    name: 'estado',
    required: false,
  ...
  @ApiOperation({
    ...
    description:
      'Retorna todas las incidencias reportadas por un usuario específico',
  })
  @ApiParam({
    name: 'usuarioId',
  ...
  @ApiOperation({
    ...
    description:
      'Retorna todas las incidencias asignadas a un trabajador específico',
  })
  @ApiParam({
    name: 'trabajadorId',
  ...
  async asignarTrabajador(
    ...
    return await this.incidenciaService.asignarTrabajador(
      incidenciaId,
      trabajadorId,
    );
  }
