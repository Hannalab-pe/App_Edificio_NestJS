...
export class PropiedadController {
  ...
  @ApiOperation({
    ...
    description:
      'Retorna una lista de todas las propiedades activas del edificio',
  })
  @ApiResponse({
    status: 200,
  ...
  async findByTipoPropiedad(
    @Param('tipoPropiedad') tipoPropiedad: string,
    @Res() res: Response,
  ) {
    try {
      const result =
        await this.propiedadService.findByTipoPropiedad(tipoPropiedad);
  ...
  @ApiOperation({
    ...
    description:
      'Retorna todas las propiedades con un estado de ocupación específico',
  })
  @ApiParam({
  ...
  @ApiResponse({
    status: 200,
    description:
      'Lista de propiedades por estado de ocupación obtenida exitosamente',
  })
  async findByEstadoOcupacion(
    @Param('estadoOcupacion') estadoOcupacion: string,
    @Res() res: Response,
  ) {
    try {
      const result =
        await this.propiedadService.findByEstadoOcupacion(estadoOcupacion);
  ...
  @ApiOperation({
    ...
    description:
      'Retorna una propiedad específica basada en su número de departamento',
  })
  @ApiParam({
  ...
  async findByNumeroDepartamento(
    @Param('numeroDepartamento') numeroDepartamento: string,
    @Res() res: Response,
  ) {
    try {
      const result =
