...
export class TipoEspacioController {
    ...
    async create(@Body() createTipoEspacioDto: CreateTipoEspacioDto, @Res() res: Response) {
        try {
    ...
    async update(@Param('id') id: string, @Body() updateTipoEspacioDto: UpdateTipoEspacioDto, @Res() res: Response) {
        try {
            const result = await this.tipoEspacioService.update(id, updateTipoEspacioDto);
