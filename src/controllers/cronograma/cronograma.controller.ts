...
export class CronogramaController {
  ...
  async create(@Body() createCronogramaDto: CreateCronogramaDto): Promise<Cronograma> {
  ...
  @ApiOperation({
    ...
    description: 'Retorna una lista de todos los cronogramas del sistema ordenados por fecha de inicio'
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description: 'Retorna todos los cronogramas que no han terminado (fecha fin >= hoy)'
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description: 'Retorna cronogramas que inicien dentro del rango de fechas especificado'
  })
  @ApiQuery({
    name: 'fechaInicio',
  ...
  async findByTipo(@Param('idTipoCronograma') idTipoCronograma: string): Promise<Cronograma[]> {
  ...
  @ApiOperation({
    ...
    description: 'Retorna todos los cronogramas asociados a un residente específico'
  })
  @ApiParam({
    name: 'idResidente',
  ...
  async findByResidente(@Param('idResidente') idResidente: string): Promise<Cronograma[]> {
  ...
  @ApiOperation({
    ...
    description: 'Retorna todos los cronogramas asignados a un trabajador específico'
  })
  @ApiParam({
    name: 'idTrabajador',
  ...
  async findByTrabajador(@Param('idTrabajador') idTrabajador: string): Promise<Cronograma[]> {
  ...
  @ApiOperation({
    ...
    description: 'Actualiza parcialmente los datos de un cronograma existente. Solo los campos enviados serán actualizados.'
  })
  @ApiParam({
    name: 'id',
    description: 'ID único del cronograma',
