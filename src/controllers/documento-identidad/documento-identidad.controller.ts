...
export class DocumentoIdentidadController {
  ...
  async create(
    ...
    return await this.documentoIdentidadService.create(
      createDocumentoIdentidadDto,
    );
  }
  ...
  @ApiOperation({
    ...
    description:
      'Retorna una lista de todos los documentos de identidad del sistema',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Retorna una lista de documentos de identidad filtrados por tipo de documento',
  })
  @ApiQuery({
    name: 'tipo',
    type: 'string',
  ...
  @ApiResponse({
    status: 200,
    description:
      'Lista de documentos de identidad por tipo obtenida exitosamente',
    type: [DocumentoIdentidad],
  })
  ...
  async update(
    ...
    return await this.documentoIdentidadService.update(
      id,
      updateDocumentoIdentidadDto,
    );
  }
