...
export class TipoContactoController {
    ...
    async create(@Body() createTipoContactoDto: CreateTipoContactoDto, @Res() res: Response) {
        try {
            const result = await this.tipoContactoService.create(createTipoContactoDto);
    ...
    async update(@Param('id') id: string, @Body() updateTipoContactoDto: UpdateTipoContactoDto, @Res() res: Response) {
        try {
            const result = await this.tipoContactoService.update(id, updateTipoContactoDto);
    ...
    @ApiResponse({
        status: 400,
        description: 'No se puede eliminar el tipo de contacto porque tiene contactos asociados'
    })
