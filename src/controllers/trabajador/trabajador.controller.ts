...
export class TrabajadorController {
  ...
  @ApiOperation({
    ...
    description: 'Crea un nuevo trabajador junto con su usuario en una transacción'
  })
  ...
  async register(@Body() createTrabajadorDto: CreateTrabajadorDto): Promise<TrabajadorRegisterResponseDto> {
  ...
  @ApiResponse({ status: 201, description: 'Trabajador creado exitosamente', type: Trabajador })
  @ApiResponse({ status: 400, description: 'Datos inválidos' })
  ...
  @ApiResponse({ status: 200, description: 'Lista de trabajadores', type: [Trabajador] })
  ...
  @ApiResponse({ status: 200, description: 'Trabajador encontrado', type: Trabajador })
  ...
  @ApiParam({ name: 'id', description: 'ID del trabajador' })
  @ApiResponse({ status: 200, description: 'Trabajador actualizado', type: Trabajador })
  @ApiResponse({ status: 404, description: 'Trabajador no encontrado' })
  async update(
    @Param('id') id: string,
  ...
  @ApiParam({ name: 'id', description: 'ID del trabajador' })
  @ApiResponse({ status: 204, description: 'Trabajador desactivado exitosamente' })
  @ApiResponse({ status: 404, description: 'Trabajador no encontrado' })
  ...
  @ApiParam({ name: 'numeroDocumento', description: 'Número de documento del trabajador' })
  @ApiResponse({ status: 200, description: 'Trabajador encontrado', type: Trabajador })
  @ApiResponse({ status: 404, description: 'Trabajador no encontrado' })
  async findByNumeroDocumento(@Param('numeroDocumento') numeroDocumento: string): Promise<Trabajador> {
  ...
  @ApiResponse({ status: 200, description: 'Lista de trabajadores por cargo', type: [Trabajador] })
