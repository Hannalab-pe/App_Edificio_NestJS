...
export class ComentarioIncidenciaController {
  ...
  async create(
    @Body() createComentarioIncidenciaDto: CreateComentarioIncidenciaDto,
  ): Promise<ComentarioIncidencia> {
    return await this.comentarioIncidenciaService.create(
      createComentarioIncidenciaDto,
    );
  }
  ...
  @ApiOperation({
    ...
    description:
      'Retorna una lista de todos los comentarios de incidencia del sistema',
  })
  @ApiResponse({
    status: 200,
  ...
  async findByIncidencia(
    @Param('idIncidencia') idIncidencia: string,
  ): Promise<ComentarioIncidencia[]> {
    return await this.comentarioIncidenciaService.findByIncidencia(
      idIncidencia,
    );
  }
  ...
  @ApiOperation({
    ...
    description:
      'Retorna todos los comentarios realizados por un usuario específico',
  })
  @ApiParam({
    name: 'idUsuario',
  ...
  async update(
    ...
    return await this.comentarioIncidenciaService.update(
      id,
      updateComentarioIncidenciaDto,
    );
  }
