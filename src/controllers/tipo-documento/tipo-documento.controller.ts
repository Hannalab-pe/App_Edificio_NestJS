...
export class TipoDocumentoController {
    ...
    async create(@Body() createTipoDocumentoDto: CreateTipoDocumentoDto): Promise<BaseResponseDto<any>> {
    ...
    async findByTipoDocumento(@Param('tipoDocumento') tipoDocumento: string): Promise<BaseResponseDto<any>> {
