...
export class ConceptoPagoService implements IConceptoPagoService {
  ...
  async create(
    ...
    try {
      const conceptoPago = this.conceptoPagoRepository.create(
        createConceptoPagoDto,
      );
      const conceptoPagoGuardado =
  ...
  async findByNombre(nombre: string): Promise<BaseResponseDto<ConceptoPago>> {
    ...
    try {
      ...
      return {
        ...
        error: {
          message:
            'Error al buscar el concepto de pago por nombre: ' + error.message,
          statusCode: 400,
        },
      };
    }
  ...
  async findByTipo(tipo: string): Promise<BaseResponseDto<ConceptoPago[]>> {
    ...
    try {
      ...
      return {
        ...
        error: {
          message:
            'Error al buscar conceptos de pago por tipo: ' + error.message,
          statusCode: 400,
        },
      };
    }
