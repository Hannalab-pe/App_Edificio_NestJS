...
export interface IResidenteService {
    ...
    register(createResidenteDto: CreateResidenteDto): Promise<ResidenteRegisterResponseDto>;
    findAll(): Promise<Residente[]>;
    findOne(id: string): Promise<Residente>;
    update(id: string, updateResidenteDto: UpdateResidenteDto): Promise<Residente>;
