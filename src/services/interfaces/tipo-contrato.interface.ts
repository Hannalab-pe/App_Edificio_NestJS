...
export interface ITipoContratoService {
    create(createTipoContratoDto: CreateTipoContratoDto): Promise<BaseResponseDto<TipoContrato>>;
    findAll(): Promise<BaseResponseDto<TipoContrato[]>>;
    findOne(id: string): Promise<BaseResponseDto<TipoContrato>>;
    update(id: string, updateTipoContratoDto: UpdateTipoContratoDto): Promise<BaseResponseDto<TipoContrato>>;
