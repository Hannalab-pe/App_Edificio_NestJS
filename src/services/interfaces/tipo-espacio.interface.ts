...
export interface ITipoEspacioService {
    create(createTipoEspacioDto: CreateTipoEspacioDto): Promise<BaseResponseDto<TipoEspacio>>;
    findAll(): Promise<BaseResponseDto<TipoEspacio[]>>;
    findOne(id: string): Promise<BaseResponseDto<TipoEspacio>>;
    update(id: string, updateTipoEspacioDto: UpdateTipoEspacioDto): Promise<BaseResponseDto<TipoEspacio>>;
