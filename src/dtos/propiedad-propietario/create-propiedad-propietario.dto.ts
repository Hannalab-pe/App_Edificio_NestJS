...
import { IsNotEmpty, IsString, IsEmail, IsUUID, IsOptional, ValidateNested, IsNumber, IsBoolean, IsDecimal } from 'class-validator';
...
class PropiedadReferenceDto {
    ...
    @IsString({ message: 'El número de departamento debe ser una cadena de texto' })
...
export class CreatePropiedadPropietarioDto {
    ...
    @IsOptional()
    @IsDecimal({ decimal_digits: '0,2' }, { message: 'El porcentaje debe ser un número decimal válido' })
