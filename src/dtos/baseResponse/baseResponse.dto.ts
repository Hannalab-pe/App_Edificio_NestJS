...
export class BaseResponseDto<T> {
    ...
    constructor(success: boolean, message: string, data?: T, error?: any, statusCode?: number) {
    ...
    static success<T>(data: T, message: string, statusCode?: number): BaseResponseDto<T> {
        return new BaseResponseDto<T>(true, message, data, undefined, statusCode);
    }

    static error<T>(message: string, statusCode?: number, error?: any): BaseResponseDto<T> {
