...
import {
  EstadoIncidencia,
  PrioridadIncidencia,
} from 'src/Enums/inicidencias.enum';
...
export class UpdateIncidenciaDto {
  ...
  @IsEnum(PrioridadIncidencia, {
    message: 'La prioridad debe ser uno de los valores válidos',
  })
  ...
  @IsDateString(
    {},
    { message: 'La fecha de resolución debe ser una fecha válida' },
  )
  ...
  @IsOptional()
  @IsUUID('4', {
    message: 'El ID del tipo de incidencia debe ser un UUID válido',
  })
